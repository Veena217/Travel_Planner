...
const ImageSelector = ({image,setImage,handleDeleteImage}) => {
  ...
  return (
    <div>
        ...
        {!image?(<button className='w-full h-[220px] flex flex-col items-center justify-center gap-4 bg-slate-50 rounded-sm border
        border-slate-200/50' onClick={()=>onChooseFile()}>
