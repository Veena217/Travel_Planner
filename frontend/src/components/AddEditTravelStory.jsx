...
const AddEditTravelStory = ({
  ...
  getAllTravelStories,
    ...
    const [visitedDate,setVisitedDate]=useState(storyInfo?.visitedDta||null)
  ...
  const handleDeleteStoryImage=async()=>{
    ...
    if(deleteImageResponse.data){
      ...
      if(response.data){
        toast.success("Stroy image deleted successfully")
  ...
  return (
    ...
    <div className="flex items-center justify-between">
      <h5 className="text-l font-medium text-slate-700">
      ...
      <div>
        <div className="flex flex-1 flex-col gap-2 pt-4">
            ...
            <input type="text" className="text-2xl text-slate-900  outlie-none" placeholder="Once Upon A Time..."  value={title}
            ...
            <div className="flex flex-col gap-2 mt-4">
                ...
                <textarea type="text" className="text-sm text-slate-950 outline-none bg-slate-100 p-2 rounded-sm"
                 placeholder="Your Story" rows={10} value={story} onChange={(e)=>setStory(e.target.value)}/>
